    ...
    <footer className="w-full text-white" style={{ backgroundColor: '#3a2818' }}>
      <div className="max-w-[1200px] mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          {/* 公司信息 */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-amber-400">GRAND MOON</h3>
          ...
          {/* 快速导航 */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-amber-400">快速導航</h3>
          ...
          {/* 更多信息 */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-amber-400">更多信息</h3>
            <ul className="space-y-2 text-gray-300 text-sm">
              <li>
                <a href="#what-we-can-do" className="hover:text-amber-400 transition-colors">
                  我們能為您做什麼
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#contact-us" className="hover:text-amber-400 transition-colors">
                  聯絡我們
                </a>
              </li>
            </ul>
          ...
          {/* 联系信息 */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-amber-400">聯繫我們</h3>
            <ul className="space-y-3 text-gray-300 text-sm">
              <li>
                <span className="block text-gray-400 mb-1">網站</span>
                <a
              ...
              <li>
                <span className="block text-gray-400 mb-1">郵箱</span>
                <a
        ...
        <div className="pt-8 border-t border-amber-800/30">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-gray-400 text-sm">
            ...
            <p className="text-xs text-gray-500">我們期待與您共同規劃家族百年基業</p>
          </div>
        </div>
      </div>
    </footer>
