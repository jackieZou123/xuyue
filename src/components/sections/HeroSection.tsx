  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-white">
        {/* 英文标题 */}
        <div className="mb-4">
          <h2 className="text-2xl md:text-3xl font-light tracking-widest mb-6 opacity-90">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="space-y-4 text-lg md:text-xl font-light leading-relaxed">
            <p className="opacity-95">為卓越者賦能，讓傳承超越財富</p>
            <p className="opacity-90">融文載道，資盈百年</p>
            <p className="opacity-95">基業長青，傳承安心</p>
            <p className="opacity-90">以智慧與遠見，成就您家族安若磐石的未來</p>
          </div>
        </div>

        {/* 底部说明文字 */}
        <div className="max-w-3xl mx-auto mt-20 pt-8 border-t border-white/20">
